  ...
  if (role === 'customer') {
    return (
      <div className="space-y-3 pb-4">
        ...
        {order.notes && (
          <Card className="p-3">
            <p className="mb-1 text-xs font-bold text-slate-500">ملاحظاتك</p>
          ...
          <Card className="p-3">
            ...
            {canEdit && (
              <div className="mt-3 border-t border-slate-100 pt-3">
                ...
                <p className="mb-2 text-xs text-slate-500">يمكنك تعديل الكميات والأسعار وحالة الطلب.</p>
        ...
        <div className="space-y-3">
          <Card className="p-3">
            ...
            <div className="grid gap-1.5 text-xs">
              ...
              <div className="flex justify-between rounded-xl bg-slate-50 px-3 py-2">
                <span className="font-bold text-slate-500">الموبايل</span>
              ...
              <div className="flex justify-between gap-3 rounded-xl bg-slate-50 px-3 py-2">
                <span className="shrink-0 font-bold text-slate-500">العنوان</span>
                <span className="text-left font-bold text-slate-800">{order.address || order.profiles?.address || 'مش محدد'}</span>
              </div>
              {order.notes && (
                <div className="rounded-xl border border-amber-100 bg-amber-50 px-3 py-2">
                  <p className="mb-0.5 text-2xs font-bold text-amber-600">ملاحظات العميل</p>
